...
def analyze_losses(data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    sut_eps_data = {
        ...
        "potencia_banco_cap": cap_bank_data.get("potencia_banco_capacitores", 0) # kVAR fornecido pelo banco (usando cap_bank_data para evitar erro se calculate_cap_bank falhar)
        # TODO: Adicionar corrente_ref_dut_a para uso direto em calculate_sut_eps_current_compensated
    }
